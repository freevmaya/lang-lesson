...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=$mainURL?>css/animation.css">
    ...
    <script src="<?=$mainURL?>js/math/vector.js"></script>
    <script src="<?=$mainURL?>js/animation/bone.js"></script>
  ...
  <body>
    ...
    <div class="d-flex w-100 mx-auto flex-column page-wrapper">
      <div class="player-wrap page-content">
        <div style="width: 1024px; height: 780px;">
          <div style="width: 1024px; height: 780px;" class="anim-canvas">

            <div class="anchor end draggable"></div>
            <div class="anchor base draggable"></div>

            <div style="width: 20px; height: 100px; left: 100px; top: 200px; background: green" class="anim-bone"></div>
            <div style="width: 23px; height: 120px; left: 200px; top: 100px; background: yellow" class="anim-bone selected"></div>
          </div>
        </div>
      </div>
