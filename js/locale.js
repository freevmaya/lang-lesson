var LocaleData = {
	rus: {
		...
		you: 'Вы',
		good: 'Хорошо',
		start_info: '<h3>Привет!</h3>Я вам расскажу что здесь нужно делать.<br>1. Прослушайте фрагмент видео<br>2. Выберите снизу слова, из которых состоит прослушанная фраза<br>3. Получите бонусы и продолжите изучение английского языка'
	},
	eng: {
		file: 'File',
		new: 'New',
